<?php
    ...
    DayAmount, Picture, BookDate FROM book INNER JOIN typebook ON book.TypeID = typebook.TypeID
    INNER JOIN statusbook ON book.StatusID = statusbook.StatusID ORDER BY BookID";
...
<body>
    <?php
        echo "
        <h3>รายละเอียดข้อมูลหนังสือทั้งหมด</h3>
        <br>
        <table border='1'>
        <tr bgcolor=''>
        ...
        <th class='data'>วันที่จัดเก็บหนังสือ</th>
